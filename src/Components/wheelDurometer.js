...
const WheelDurometer = () => (
  <div className="WheelDurometer">
    <h2> Wheel Durometer</h2>

    <div className="wheelHardness">
      <p className="soft73a">73a</p>
      <p className="hard101a">101a</p>
    </div>
    ...
    <div className="wheelDurometerContainer">
      ...
      <div className="lineContainer">
        <div className="softHardLineContainer">
          <p className="label">Soft</p>
          <hr className="softHardLine" />
          <p className="label">Hard</p>
        </div>
        <div className="slideLineContainer">
